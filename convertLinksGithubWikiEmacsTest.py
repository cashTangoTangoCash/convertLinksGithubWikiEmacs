...
import convertLinksGithubWikiEmacs as CLG
import unittest
...
class SanityCheckOfLineConversion(unittest.TestCase):
    def testSanity1(self):
        ...
        f1=CLG.add_md_to_links_in_line
        f2=CLG.remove_md_from_links_in_line
    ...
    def testSanity2(self):
        ...
        f1=CLG.remove_md_from_links_in_line
        f2=CLG.add_md_to_links_in_line
        newLine1=f1(testLine)
        newLine2=f2(newLine1)
        self.assertEqual(testLine,newLine2)
